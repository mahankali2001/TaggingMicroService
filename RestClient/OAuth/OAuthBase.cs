...
namespace MicroService
{
    ...
    public sealed class OAuthBase
    {
        ...
        private const string WebconsumerSecret = "xyz123";
        //private Uri uri = new Uri("http://localhost/XYZ/REST/1.0");
        ...
        public string GenerateSignatureForDMWebClient(Uri uri, string httpMethod)
        {
            string url, param;
            var nonce = GenerateNonce();
            var timeStamp = GenerateTimeStamp();
            var signature = GenerateSignature(uri, WebConsumerKey, WebconsumerSecret, string.Empty, string.Empty, httpMethod, timeStamp, nonce, OAuthBase.SignatureTypes.HMACSHA1, out url, out param);
